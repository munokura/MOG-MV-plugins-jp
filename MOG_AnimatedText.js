...
/*:ja
 * @plugindesc (v1.3) マップ画面でテキストをアニメーション表示します。
 * @author Moghunter
 *
 * @param Letter Space X-Axis
 * @text 文字のX軸間隔
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * マップ画面でテキストをアニメーション表示します。
 *
 * ===========================================================================
 * プラグインコマンド
 * ===========================================================================
 * テキストを表示するには、以下のコマンドを使用します。
 *
 * infotext : ID : MODE : X : Y : FONTSIZE : DURATION : SPEED : COLOR : ALIGN :TEXT
 *
 * ID - テキストID
 ...
 * SPEED - 全文字を表示するまでの時間（小さい方が早く表示されます）
 * COLOR - 文字色
 *       - 0..32
 * ALIGN - 文字の並び方向
 *       0 - 横
 ...
 *        - 文字色の変更機能を追加
 *        - 新しいアニメーションの追加
 * (v1.2) - 地図を変更した後の自動データリセット
 *          コマンドプラグイン(clearinfotext)を追加
 * (v1.1) - クリア効果使用時のクラッシュの修正
 */
