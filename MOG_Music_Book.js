...
/*:ja
 * @plugindesc (v1.5) ゲーム中に再生した曲にアクセスできるシーンを追加します。
 * @author Moghunter
 *
 * @param Command Menu
 * @text 音楽メニューの有効化
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * ゲーム中に再生した曲にアクセスできるシーンを追加します。
 * ===========================================================================
 * デフォルトで、メインメニューから音楽シーンにアクセスできます。
 * シーンを呼び出すには、プラグインコマンドから次のコマンドを使用します。
 *
 * music_book
 *
 * ===========================================================================
 * 下記フォルダに必要な画像ファイルを保存してください。
 *
 * /img/musicbook/
 *   Music_Book_A.png
 *   Music_Book_B.png
 *   Music_Book_C.png
 *
 * 再生時に表示する画像ファイル名は音楽ファイル名と同じである必要があります。
 * 再生時にパーティクルを表示する場合、パーティクル画像を保存してください。
 *
 * ===========================================================================
 * 曲の説明とタイトルのリストのデータが必要です。
 * データは、スクリプト内の「TITLES SETTING」リストを直接書き換えます。
 *
 * [FILE_NAME","TITLE_OF_MUSIC","DESCRIPTION","PARTICLE_NAME",PX,PY],
 * 行末の , は最後の行だけ削除してください。
 *
 * FILE_NAME      - 曲のファイル名
 * TITLE_OF_MUSIC - 曲のタイトル
 * DESCRIPTION    - 曲の説明
 * PARTICLE_NAME  - パーティクルファイル名(オプション)
 * PX             - パーティクル水平方向速度
 * PY             - パーティクル垂直方向速度
 *
 * 例
