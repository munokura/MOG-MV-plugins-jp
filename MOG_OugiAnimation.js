...
/*:ja
 * @plugindesc (v1.3) スキル実行時にピクチャアニメーションを再生します。
 * @author Moghunter
 *
 * @param For Enemies
 * @text 敵の奥義アニメ有効化
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * スキル実行時にアニメーション(画像のズームアウト・イン・フェードアウト)
 * を再生します。
 *
 * ===========================================================================
 * 2つの画像が必要になります。
 * 画像は下記のフォルダの中に保存してください。
 * /img/pictures/
 *
 * ファイル名は下記のルールに従ってください。
 *
 * Actor_ID.png
 * Actor_ID + SUFIX.png
 *
 ...
 *
 * ===========================================================================
 * どのアニメーションに奥義のアニメーションを指定するには、
 * スキルのメモ欄に下記のメモタグを記入してください。
 *
 *  Ougi Animation: _SUFIX
 *
 * 例
 *
 *  Ougi Animation: _Ougi
 *  Ougi Animation: _Angry
 *  Ougi Animation: _Happy
 *  ...
 * ===========================================================================
 * 更新履歴
 * ===========================================================================
 * (v1.3) - アニメーションを起動しないランダムなバグを修正
 * (v1.2) - 画像がないときに画面をロックする修正
 * (v1.1) - コーディングの改善
 */
