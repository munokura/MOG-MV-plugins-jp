 ...
 * A edição do plugin deve ser feita a partir da linha ''// SETUP''.
 *
 * ===========================================================================
 * HISTÓRICO
 * ===========================================================================
...
/*:ja
 * @plugindesc (v1.4) 戦闘に(行動、ダメージ、勝利など)加える声を設定
 * @author Moghunter
 *
 * @param Volume
 * @text 基本音量
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * 戦闘に(行動、ダメージ、勝利など)加える声を設定するには、
 * プラグインを手動で編集する必要があります。
 * プラグインの編集は''// SETUP''以下から行ってください。
 *
 * ===========================================================================
 * 変更履歴
 * ===========================================================================
 * (v1.4) - メニュー内の音声再生の修正。
 *        - 変形効果で敵IDを更新しない修正。
 * (v1.3) MOG Battle Resultとの互換性。
 * (v1.2) MOG Battle Transitionsとの互換性。
 * (v1.1) 行動時にキャラクターが動かないバグを修正。
 */
...
//
// A - Actor ID（アクターID）
// B - File Name（ファイル名：拡張子省略、大文字小文字を区別）
//
// -----------------------------------------------------------------------
...
Moghunter.v_actor_item[1] = {
	...
	3: ["P1_Action_01", "P1_Action_02", "P1_Action_03"]
}; // Full Potion
