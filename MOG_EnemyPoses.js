...
/*:ja
 * @plugindesc (v1.4) 戦闘中の敵にポーズを追加します。
 * @author Moghunter
 *
 * @help
 * 翻訳:ムノクラ
 ...
 * メモタグ
 * ===========================================================================
 * ポーズを有効にするには、敵のメモ欄に下記のタグを追加してください。
 *
 * Battler Poses
 *
 * ===========================================================================
 ...
 * Slime[Poses].png
 *
 * ポーズ画像は元の画像と同じ幅の画像を4種類用意し、横に結合したファイルです。
 * ・待機
 * ・回復
 * ・攻撃
 * ・被ダメージ及び残HP低
...
Game_Action.prototype.apply = function (target) {
	...
	if (oldhp > target.hp && this.item().damage.type != 0) {
		target.setBPose(3);
