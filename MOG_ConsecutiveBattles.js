 ...
 *
 * ===========================================================================
 * 連続戦闘数を表示/非表示にするには、以下のコマンドを使用します。
 *
 * hide_wave_number
 * show_wave_number
 *
 * ===========================================================================
 * 戦闘開始時のアニメーションを表示/非表示にするには、
 * 以下のコマンドを使用します。
 *
 * hide_phase_animation
 * show_phase_animation
 ...
 * 下記のようにイベントを設定します。
 *
 * プラグインコマンド：consecutive_battles : 2
 * 戦闘の処理：敵グループ1
 *
 * 上記のイベントでは、1回戦が敵グループ1、2回戦が敵グループ2となります。
 * プラグインコマンド実行後の最初の戦闘(ランダムエンカウントも可)が
 * 連続戦闘になります。
 *
 * ===========================================================================
 * 注意点・バグ(追記)
 ...
 * プラグインコマンド hide_wave_number を使用したりすると、
 * 戦闘開始時に停止するバグ。
